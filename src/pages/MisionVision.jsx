    ...
    <div id="fondo">
      ...
      <div className='container' >
        ...
        <div className='row'>
          <div className='col-md-4'>
            <div className='card'>
              <h3 className='subTilulosMiViVa'>VALORES</h3><hr />
              <p className='parrafoMiViVa'>Actuamos con honestidad y transparencia en todas nuestras interacciones, cumpliendo siempre con altos estándares éticos.</p>
            </div>
          </div>
        </div>
      </div>
